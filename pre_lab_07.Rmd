...
**Answer**I see a page about employment statistics, with many tables breaking down the different employment industries.
...
**Answer** I see lots of HTML code.
...
**Answer** a list containing an HTML head tag and body tag with information from the website in each tag
...
**Answer** an HTML tag with the head tag and body tag nested inside it
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The word sectors is in a span tag. The span tag is nested in a caption tag that's nested in a table tag.
...
**Answer** There are seven tibbles, one for each table on the web page. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It is a list of all the tables we just pulled from the website
...
**Answer** It brings up each table
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It is a table of Each Sector and a description of the sector number.
...
**Answer** One tibble of the table from the website we wanted
...
**Answer** It lowercased the headings and got rid of the laast row in the tibble
...
**Answer** a cleaned tibble of the sector and description od each sector number
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Information for NAICS sector 22
